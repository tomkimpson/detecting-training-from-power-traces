...
itself (\cref{subsec:meter_spec}). This is the sense in which the passive results
are necessary conditions and an upper bound on hideability, not a proof of
training: they bound what a prover can hide from a fixed detector cheaply, and
they locate --- but do not close --- the cost of hiding from the tracker.
...
physics the cost-of-hiding argument of \cref{sec:frontier} leans on. And an
...
\begin{table*}[t]
	...
	\begin{tabular}{@{}p{2.4cm}p{5.0cm}p{2.2cm}p{4.6cm}@{}}
		...
		loads with a training-shaped schedule score as training \\
...
budgets we specified; a family we did not model is outside it. And the
learning-efficiency cost of de-periodicisation --- the axis that would turn the
frontier into a full cost-of-hiding statement --- is stated, not measured, and
remains the central open empirical question.
