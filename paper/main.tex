...
observation time. We leave it, with the identifiability question of
\cref{sec:threat} and the cost-of-hiding frontier of \cref{sec:frontier}, as the
active-verification direction the passive results here motivate but cannot reach
(\cref{sec:discussion}).
